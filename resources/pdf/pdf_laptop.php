<?php
        ...
        $pdf->SetTextColor(0, 0, 0);
        $ns = $pdf->WordWrap($text, 120);
        $pdf->Write(5,utf8_decode('  	    Este equipo de cómputo (*) fue asignado a '));
        ...
        $pdf->SetTextColor(0, 0, 0);
        $ns = $pdf->WordWrap($text, 120);
        $pdf->Write(5,utf8_decode('  	    Este equipo de cómputo (*) es su responsabilidad, el cuidado del mismo desde el momento que fue asignado a usted y podrá ser o no transferido con usted en cualquier movimiento de posición dentro de GE. '));
        $pdf->ln();
        ...
        $pdf->SetTextColor(0, 0, 0);
        $ns = $pdf->WordWrap($text, 120);
        $pdf->Write(5,utf8_decode('Color: Negro'));
        $pdf->ln();
        $pdf->ln();
        $pdf->ln();
        $pdf->ln();
